...
function labels = sgraph(k,dataname,fn) 

scriptfile = ['' 'partgraph' num2str(fn) num2str(sum(dataname=='0')) num2str(sum(dataname=='1')) num2str(sum(dataname=='2')) num2str(sum(dataname=='3')) '.bat'];
display(dataname);
if ~exist('dataname'),
      dataname = ['' 'graph0'];
end;
